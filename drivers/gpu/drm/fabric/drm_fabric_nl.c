...
static const struct nla_policy drm_fabric_fabric_new_nl_policy[DRM_FABRIC_A_INSTANCE_ID + 1] = {
	[DRM_FABRIC_A_TYPE] = NLA_POLICY_RANGE(NLA_U32, 1, 1),
	[DRM_FABRIC_A_NAME] = { .type = NLA_NUL_STRING, .len = 31, },
	[DRM_FABRIC_A_INSTANCE_ID] = { .type = NLA_U64, },
};
...
static const struct genl_split_ops drm_fabric_nl_ops[] = {
	...
	},
	{
		...
		.maxattr	= DRM_FABRIC_A_INSTANCE_ID,
